    ...
    <div className="cart">
      {
        ...
        <>
          ...
          {
            stage !== 3 ?
            <p className="cart__offert">¡SE ACERCAN LAS MUESTRAS DE FIN DE AÑO! Aprovecha un 20% OFF en compras al por mayor</p>
            :
            <CartMessage/>
          }
        </>
        ...
        <>
          <div className="cart__empty">
            ...
            <p className="cart__empty__text">Todas tus marcas favoritas en un solo lugar y puedes comprarlas hasta en 18 cuotas sin recargo.</p>
