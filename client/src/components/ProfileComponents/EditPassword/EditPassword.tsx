...
const changePasswordSchema = Yup.object().shape({
    actualPassword: Yup.string().min(6, "Contraseña minimo 6 caracteres").required("Contraseña requerida"),
    newPassword: Yup.string().min(6, "Contraseña minimo 6 caracteres").required("Contraseña requerida"),
        ...
        <div className="profile__password">
            ...
            {({ errors, touched }) => (
                <Form className="profile__password__form">
                    <label className="profile__password__form__label" htmlFor="actualPassword">Contraseña Actual</label>
                    ...
                    {errors.actualPassword && touched.actualPassword ? (
                        <div className="profile__password__form__container__error">{errors.actualPassword}</div>
                    ) : null}

                    <label className="profile__password__form__label" htmlFor="newPassword">Nueva Contraseña</label>
                    <div className="profile__password__form__container">
                        <Field
                        className="profile__password__form__container__field"
                        name="newPassword"
                    ...
                    <label className="profile__password__form__label" htmlFor="newPasswordConfirm">Confirmar Contraseña</label>
                    <div className="profile__password__form__container">
                        <Field
                        className="profile__password__form__container__field"
                    ...
                    {errors.newPasswordConfirm && touched.newPasswordConfirm ? (
                        <div className="profile__password__form__container__error">{errors.newPasswordConfirm}</div>
                    ) : null}
                    s
