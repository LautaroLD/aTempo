...
const { productList, productDetail } = require("../controllers/product.controller")
...
//routerProduct.post('/save', checkMultipart, handleUploadFirebase, checkSchema(productSchema), handleValidator, saveProduct);

//routerProduct.put('/update/:id', checkSchema(productSchema), handleValidator, updateProduct);
